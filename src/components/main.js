            ...
            <article>
                <div className="row justify-content-evenly align-items-center pt-4">
                    ...
                    <div className="col-md-6">
                        ...
                        <p className="fs-5">
                            Undergraduate Informatics Student at Universitas Sebelas Maret |
                        ...
                        <div className="d-flex justify-content-evenly align-items-start gap-4">
                            ...
                            <div className="d-flex flex-column align-items-center mb-3">
                                <svg
                                    ...
                                    height="32"
                                    fill="currentColor"
                                    className="bi bi-file-earmark-post mb-2"
                                    viewBox="0 0 16 16"
                                >
                                ...
                                <a
                                    href="https://drive.google.com/file/d/1DWp5CJmfzJgGJu6qQy5FIrav6eoW8O-m/view?usp=sharing"
                                    className="btn btn-outline-primary"
                                >
                                    Curriculum Vitae
                                </a>
